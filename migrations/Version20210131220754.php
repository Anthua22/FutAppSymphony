 ...
 */
final class Version20210131220754 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE partido (id INT AUTO_INCREMENT NOT NULL, arbitro_id INT DEFAULT NULL, equipo_local_id INT DEFAULT NULL, equipo_visitante_id INT DEFAULT NULL, direccion_encuentro VARCHAR(255) NOT NULL, fecha_encuentro VARCHAR(255) NOT NULL, resultado VARCHAR(6) DEFAULT NULL, observaciones VARCHAR(255) DEFAULT NULL, INDEX IDX_4E79750B66FE4594 (arbitro_id), INDEX IDX_4E79750B88774E73 (equipo_local_id), INDEX IDX_4E79750B8C243011 (equipo_visitante_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
